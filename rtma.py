...
isodrosotherms_outlined = ax.contour(tdf.metpy.x, tdf.metpy.y, tdf_smoothed, transform=tdf.metpy.cartopy_crs, colors='Black', levels=np.arange(45, 86, 1), extend='both')
