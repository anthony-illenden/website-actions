...
for i in range(0, len(ds['time'])):
    ...
    plt.title('{} NAM 12KM: 500 hPa Absolute Vorticity and Geopotential Heights | {} | {}'.format(abs_vort[time_dim][0].dt.strftime('%H00 UTC').item(), abs_vort[time_dim].dt.strftime('%Y-%m-%d %H00 UTC').item(), i))
