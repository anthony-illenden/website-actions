...
tds_rap = TDSCatalog('https://thredds.ucar.edu/thredds/catalog/grib/NCEP/GFS/Global_0p25deg/latest.html')

rap_ds = tds_rap.datasets[0]
ds = xr.open_dataset(rap_ds.access_urls['OPENDAP'])
ds = ds.metpy.parse_cf()

start_time, end_time = ds.time2[0], ds.time2[28]
target_lat, target_lon =  42.66, -83.41

ds_point = ds.sel(time2=slice(start_time, end_time))
ds_point = ds_point.sel(lat=target_lat, lon=360+target_lon, method='nearest')
